...
gui.add(u.uSize, "value")
    .name("star size")
gui.add(u.uBranches, "value")
    .name("branch num")

const cRadius = gui.add(u.uRadius, "value")
    .name("scale")
const cSpin = gui.add(u.uSpin, "value")
    .name("spin")
const cRandomness = gui.add(u.uRandomness, "value")
    .name("scatter")
